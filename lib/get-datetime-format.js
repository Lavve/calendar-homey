...
module.exports = app => {
  const dateFormat = this.homey.settings.get(app.variableMgmt.setting.dateFormat) || Homey.__('settings.datetime.date.default')
  const timeFormat = this.homey.settings.get(app.variableMgmt.setting.timeFormat) || Homey.__('settings.datetime.time.default')
